...
public class Lesson4 {
    public static void main(String[] args) {
        ...
        Integer[] allWeeks = new Integer[lengthOfPeriod];  // Инициализируем массив для недельных оценок.
        ...
        for (int i  = 0; i < lengthOfPeriod; i++) {    // Вывод статистики выполненных задач по неделям.
            int k = i + 1;
            System.out.println("На " + Integer.toString(k) + "ой неделе было выполенено " + Integer.toString(allWeeks[i]) + " задач.");
        }

        int summ = 0;            // Переменная для рассчета суммы выполненых заданий.
